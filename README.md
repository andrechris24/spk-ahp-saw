...
3. Enter `composer install`. If you receive message "Your lock file does not contain compatible sets of packages", enter `composer update`.
...
7. Enter `php artisan serve`, and you are ready to go!
