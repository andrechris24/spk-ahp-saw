...
<form action="{{ route('register.perform') }}" method="POST" enctype="multipart/form-data"
	...
	<div class="form-group position-relative has-icon-left mb-4">
		<input type="text" name="name" maxlength="99" placeholder="Nama lengkap" maxlength="99"
			value="{{ old('name') }}" class="form-control form-control-xl 
	...
	<div class="form-group position-relative has-icon-left mb-4">
		<input type="password" placeholder="Password" name="password" minlength="8" maxlength="20" id="password"
			class="form-control form-control-xl @error('password') is-invalid @enderror "
			oninput="checkpassword()" data-bs-toggle="tooltip" data-bs-placement="top" required
	...
	<div class="form-group position-relative has-icon-left mb-4">
		<input type="password" placeholder="Konfirmasi Password" maxlength="20" id="confirm-password"
			name="password_confirmation" minlength="8" oninput="checkpassword()" class="form-control form-control-xl @error('password_confirmation') is-invalid @enderror " required />
		<div class="form-control-icon"><i class="bi bi-shield-lock"></i></div>
		<div class="invalid-feedback">
