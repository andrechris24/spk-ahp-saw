							...
							<li class="sidebar-item has-sub">
								...
								<ul class="submenu">
									<li class="submenu-item">
										<a href="{{ url('bobotkriteria') }}">Kriteria dan Bobot</a>
									</li>
									<li class="submenu-item">
										<a href="{{ url('ratingkriteria') }}">Rating Kriteria</a>
									</li>
									<li class="submenu-item">
										<a href="{{ url('skoralternatif') }}">Alternatif dan Skor</a>
									</li>
								</ul>
							</li>
							<li class="sidebar-item has-sub">
								...
								<ul class="submenu">
									<li class="submenu-item">
										<a href="extra-component-avatar.html">Matriks Keputusan</a>
									</li>
									<li class="submenu-item">
										<a href="extra-component-sweetalert.html">Normalisasi</a>
									</li>
									<li class="submenu-item">
										<a href="extra-component-toastify.html">Peringkat</a>
									</li>
								</ul>
							</li>
							@endauth
					...
					<div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<p>Anda akan logout dari Sistem Pendukung Keputusan.</p>
							</div>
                        ...
                        <p class="text-center py-2 mb-0">
                          <a href="#">See all notification</a>
								...
								<div class="dropdown">
									...
									>
										<li>
											<h6 class="dropdown-header">Setelan User</h6>
										</li>
										<li>
