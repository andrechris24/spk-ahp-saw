						...
						<div class="form-body">
							<div class="row">
									...
									<div class="form-group has-icon-left">
										<div class="position-relative">
											<input type="text" class="form-control" name="name" placeholder="Name"
												id="first-name-icon" value="{{ auth()->user()->name }}" required />
									...
									<div class="form-group has-icon-left">
										<div class="position-relative">
											<input type="email" class="form-control" name="email" placeholder="Email"
												id="first-name-icon" value="{{ auth()->user()->email }}" required />
											<div class="form-control-icon">
								...
								<div class="col-md-8">
									<div class="form-group has-icon-left">
										<div class="position-relative">
											<input type="password" name="password" class="form-control" placeholder="8-20 karakter"/>
											<div class="form-control-icon"><i class="bi bi-lock"></i></div>
										</div>
									</div>
								</div>
