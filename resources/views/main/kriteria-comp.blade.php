...
<?php use App\Http\Controllers\KriteriaController;?>
@section('content')
								...
								<div class="tab-content" id="InputCompTabContent">
														...
														@for($a=0;$a<($total-1);$a++)
															@for($b=0;$b<$total;$b++)
																@php
																	...
																	$nilai=$kriteriacontroller->getCriteriaComp($a,$b);
																@endphp
																<tr>
																	<td>
																	...
																	<td>
																		...
																		@else
																		<input type="number" name="bobot[{{ $urutan }}]" 
																		class="form-control" value="{{ $nilai }}" min="1" max="9" required>
																		@endif
																	</td>
																</tr>
															@endfor
									...
									@else
										<div class="alert alert-warning">
											Masukkan data <a href="{{ url('kriteria') }}">Kriteria</a> dulu untuk melakukan perbandingan (Minimal 2).
										</div>
									@endif
									</div>
								</div>
